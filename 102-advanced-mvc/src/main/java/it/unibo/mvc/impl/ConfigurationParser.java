...
public final class ConfigurationParser {
    ...
    private static final Path PATH = Path.of("src/main/resources/config.yml");
    // Default values
        ...
        try {
            ...
            for (final var line : lines) {
                ...
                switch (key) {
                    ...
                    default -> {
                        System.out.println("Unknown configuration key: " + key); // NOPMD
                    }
                }
            }
            ...
            System.out.println("Using default configuration due to error: " + e.getMessage()); // NOPMD
            return new Configuration.Builder()
                    .setMin(DEFAULT_MIN)
                    .setMax(DEFAULT_MAX)
